...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Log in",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w500),),
   ...
   backgroundColor: Colors.black,
       body: Column(
         children: [
           Container(
             ...
             child: Text("Log in with one of following options.",style: TextStyle(color: Colors.white,letterSpacing: 1),),
           ),
    ...
    Padding(  
      ...
      Container(
        ...
        child: Center(child: Text("Log in",style: TextStyle(color: Colors.white,letterSpacing: 1,fontWeight: FontWeight.w800,fontSize: 15),),),
           ...
           Row(
             ...
             children: [
               ...
               style: TextStyle(
                 ...
                 Text(" Sign up",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700),)
